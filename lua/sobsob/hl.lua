return function(cp)
	return {
		...
		PreCondit                                  = { fg = cp.orange, bg = cp.red }, -- TODO: check what that is and make it beautiful
		SpecialChar                                = { fg = cp.violet, bg = cp.red }, -- TODO: the same as above
		-- Function
		...
		String                                     = { fg = cp.green },
		-- Operator
		Operator                                   = { fg = cp.cyan, bg = cp.red }, -- TODO: check what that is
		-- Delimiter
		Delimiter                                  = { fg = cp.violet },
		-- Html tags
		htmlTag                                    = { fg = cp.violet },
		htmlTagName                                = { fg = cp.purple },
		htmlEndTag                                 = { fg = cp.violet },
		htmlSpecialTagName                         = { fg = cp.cyan },
		htmlTagN                                   = { fg = cp.purple, bg = cp.red }, -- TODO: check what that is
		-- Html args

		htmlArg                                    = { fg = cp.yellow },
		htmlArgN                                   = { bg = cp.red }, --numeric attribute overlays -- TODO: check what that is
		htmlValue                                  = { fg = cp.red }, -- attribute value (raw)
		htmlString                                 = { link = "String" }, -- string in attributes
		htmlStringDQ                               = { link = "htmlString" }, -- double‑quoted string
		htmlStringSQ                               = { link = "htmlString" }, -- single‑quoted string
		htmlLink                                   = {}, -- URL values
		...
		["@constructor"]                           = { fg = cp.purple, bold = true },
		["@label"]                                 = { fg = cp.purple, bold = true },
		-- Type
		["@type"]                                  = { fg = cp.yellow },
